    ...
    return (
        <div className="h-screen w-full overflow-hidden flex flex-col items-center justify-center font-retro text-gray-800 relative bg-[#87CEEB]">
            <style>{`
                ...
                .cloud-h { animation: float-h 20s linear infinite; }
                ...
                .pixel-bird-wrapper-2 .pixel-bird {
                    transform: scale(0.7);
                }

                @keyframes fly-across {
                    0% { transform: translateX(0) translateY(0); }
                    20% { transform: translateX(25vw) translateY(-2vh); }
                    40% { transform: translateX(50vw) translateY(2vh); }
                    60% { transform: translateX(75vw) translateY(-1vh); }
                    80% { transform: translateX(90vw) translateY(2vh); }
            ...
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                {/* Clouds */}
                <div className="absolute top-[10%] left-[10%] w-[60px] h-[20px] pixel-cloud-retro cloud-h"></div>
                <div className="absolute top-[20%] left-[70%] w-[80px] h-[25px] pixel-cloud-retro cloud-h" style={{ animationDelay: '-5s', animationDirection: 'reverse' }}></div>

                {/* Flying Birds */}
                <div className="pixel-bird-wrapper">
                    <div className="pixel-bird">
                        <div className="pixel-wing"></div>
                    </div>
                </div>
                <div className="pixel-bird-wrapper-2">
                    <div className="pixel-bird">
                        <div className="pixel-wing"></div>
                    </div>
                </div>
